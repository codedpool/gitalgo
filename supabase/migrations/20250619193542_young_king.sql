...
DROP FUNCTION IF EXISTS update_repository_full_name();
DROP FUNCTION IF EXISTS handle_new_user();
DROP FUNCTION IF EXISTS update_repository_stars_count();
DROP FUNCTION IF EXISTS update_repository_forks_count();
DROP FUNCTION IF EXISTS update_issue_comments_count();
DROP FUNCTION IF EXISTS update_profile_counts();
DROP FUNCTION IF EXISTS update_user_repo_count();
